...
$(document).ready(function(){
	...
	$("#max-text-area").keypress(function(){
		if($(this).val().length>599){
			return false;
		}
	});
	$("#max-text-area").keyup(function(){
		if($(this).val().length>599){
			return false;
		}
	});
	$("#max-text-area").keydown(function(){
		if($(this).val().length>599){
			return false;
		}
	});
...
<ul id="nav">
	...
	<li><a href="/applyip.php" class="active">INTERNATIONAL PRESS</a></li>
	</ul>
	</li>
...
<div class="content-wrappper black">
	...
	<h2>Apply for International Press</h2>
	<form name="ip-application-form" id="ip-application-form" class="application-form" action="#" method="post">
	...
	<tr><th>Write an article regarding <br/>the women's day celebration <br/>all over the world in your own words.
	</th><td><textarea name="exp" class="input-box" id="max-text-area"></textarea></td></tr>
