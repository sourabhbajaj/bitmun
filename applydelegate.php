...
$(document).ready(function(){
	...
	$("#double-delegate").change(function(){
		if($(this).is(":checked")){
			$(".double-delegate-row").show();
		}else{
			$(".double-delegate-row").hide();
		}
	});
});
</script>
...
<ul id="nav">
	...
	<ul class="sub-nav">
	<li><a href="/applydelegate.php" class="active">DELEGATE</a></li>
...
<div class="content-wrappper black">
	...
	<h2>Apply for Delegate</h2>
	<form name="delegate-application-form" id="delegate-application-form" class="application-form" action="#" method="post">
	...
	<tr><th>Country Preference : </th><td><input type="text" name="country" class="input-box"/></td></tr>
	<tr><th>&nbsp;</th><td><input type="checkbox" name="double" value="1" id="double-delegate" style="display:inline;"/><label for="double"  style="display:inline;">Double Delegate</label></td></tr>
	<tr class="double-delegate-row"><th>Partner Name : </th><td><input type="text" name="partner-name" class="input-box"/></td></tr>
	<tr class="double-delegate-row"><th>Partner Contact Number : </th><td><input type="text" name="partner-number" class="input-box"/></td></tr>
	...
	<tr><th>MUN Experience as Delegate: <br/>
	(if any.)
